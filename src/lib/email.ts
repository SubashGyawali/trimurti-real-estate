    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f5f5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Phone:</strong> <a href="tel:+91${data.phone}">${data.phone}</a></p>
        ...
        <div style="background-color: #e8f4f8; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          ${data.propertyUrl ? `<p><a href="${data.propertyUrl}" style="color: #3b82f6;">View Property</a></p>` : ""}
        </div>
        `
            : ""
        }
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e0e0e0; color: #666; font-size: 12px;">
          ...
          <p>Quick Actions:
            <a href="tel:+91${data.phone}" style="color: #3b82f6;">Call</a> |
            <a href="https://wa.me/91${data.phone}" style="color: #25D366;">WhatsApp</a>
          </p>
        </div>
      </div>
    `;
